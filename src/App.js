...
const ResetPassword = lazy(() =>
  import('./container/user/setting/resetPassword/ResetPassword'),
)
const DeleteAccount = lazy(() =>
  import('./container/user/setting/deleteAccount/DeleteAccount'),
)

const Parent = lazy(() => import('./container/parent/Parent'))
const ParentDetail = lazy(() =>
  import('./container/parent/parentDetail/ParentDetail'),
)
const ChildrenDetail = lazy(() =>
  import('./container/parent/childDetail/ChildDetail'),
)
